...
//				.formLogin().loginPage("/login").permitAll().and().logout().permitAll();
		...
		http.authorizeRequests().antMatchers("/", "/home", "/newaccount","/invalidSession.html").permitAll().and().authorizeRequests()
				.antMatchers("/admin/**").hasAnyRole("ADMIN").antMatchers("/user/**").hasAnyRole("USER")
				.anyRequest()
				.authenticated().and().formLogin().loginPage("/login").permitAll().successHandler(myAuthenticationSuccessHandler())
